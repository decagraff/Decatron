...
namespace Decatron.Migrations
{
    ...
    partial class DecatronDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Decatron.Core.Models.UserChannelPermissions", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ChannelOwnerId")
                        .HasColumnType("bigint")
                        .HasColumnName("channel_owner_id");
                    ...
                    b.Property<long>("GrantedUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("granted_user_id");
                    ...
                    b.HasIndex("AccessLevel")
                        .HasDatabaseName("idx_access_level");

                    b.HasIndex("ChannelOwnerId")
                        .HasDatabaseName("idx_channel_owner");

                    b.HasIndex("GrantedBy");

                    b.HasIndex("GrantedUserId")
                        .HasDatabaseName("idx_granted_user");

                    b.HasIndex("ChannelOwnerId", "GrantedUserId")
                        .IsUnique()
                        .HasDatabaseName("idx_channel_granted_user");

                    b.ToTable("user_channel_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Decatron.Core.Models.UserChannelPermissions", b =>
                {
                    b.HasOne("Decatron.Core.Models.User", "ChannelOwner")
                        .WithMany()
                    ...
                    b.HasOne("Decatron.Core.Models.User", "GrantedByUser")
                        .WithMany()
                    ...
                    b.HasOne("Decatron.Core.Models.User", "GrantedUser")
                        .WithMany()
